...
class ACT2 extends CI_Controller
{
	...
	public function a10_2()
	{
		...
		$data['str']['v1'] = $this->input->get('v1');
		$data['str']['v2'] = trim($this->input->get('v2')); //품목
		$data['str']['v3'] = trim($this->input->get('v3')); //색상
	...
	public function a12()
	{
		...
		$data['title'] = "";
		$data['List'] = $this->act_model->act_a12_list($params, $start, $config['per_page']);
		$this->data['cnt'] = $this->act_model->act_a12_cut($params);
		...
		$this->load->view('/act/a12', $data);
	}


	public function a12_1()
	{
		check_pageLevel();
