...
$config['site_title']['SYS']['menu'] = "메뉴권한관리";
...
$config['site_title']['PLN']['p2'] = "생산계획등록";
$config['site_title']['PLN']['p3'] = "생산계획조회";


$config['site_title']['ACT'][''] = "작업지시등록";

$config['site_title']['ACT']['a1'] = "공정별작업지시";
$config['site_title']['ACT']['a2'] = "건조(재고)현황";
$config['site_title']['ACT']['a3'] = "공정별 작업보고관리";
$config['site_title']['ACT']['a4'] = "공정별진행내역";
$config['site_title']['ACT']['a5'] = "기간별생산실적";
$config['site_title']['ACT']['a6'] = "공정별수율관리";
$config['site_title']['ACT']['a7'] = "공정별불량관리";

$config['site_title']['ACT']['an1'] = "수주대비 출고내역";
$config['site_title']['ACT']['an2'] = "불량보고관리";
$config['site_title']['ACT']['an3'] = "선별작업일지";
$config['site_title']['ACT']['an4'] = "생산현황판-사무동";
$config['site_title']['ACT']['an5'] = "생산현황판-공장동";
...
$config['site_title']['ACT2']['a8'] = "성형실적";
$config['site_title']['ACT2']['a8_1'] = "성형실적현황";
$config['site_title']['ACT2']['a9'] = "정형실적";
$config['site_title']['ACT2']['a9_1'] = "정형BK";
$config['site_title']['ACT2']['a9_2'] = "정형실적현황";
$config['site_title']['ACT2']['a10'] = "시유실적1";
$config['site_title']['ACT2']['a10_1'] = "시유실적2";
$config['site_title']['ACT2']['a10_2'] = "시유실적현황";
...
$config['site_title']['tablet'][''] = "작업지시";
$config['site_title']['tablet']['index'] = "작업지시";
...
$config['sess_cookie_name'] = 'rsession';
