                ...
                <div class="none_padding">
                    <table class="nhover">
                        <tbody>
                            ...
                            <tr>
                                <th>완료수량</th>
                                <td colspan="3"><input type="number" name="QTY" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form_input5 input_5 cupop right" value="<?php echo $row->ORDER_QTY; ?>"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
