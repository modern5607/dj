            ...
            <div class="ac_table">
                <table class="nhover">
					...
					?>
                        <tr>
                            <th>품명</th>
                            <td colspan="3"><input type="text" name="name" class="form_input input_100" disabled
                                    value="<?=$row->ITEM_NM?>"></td>
                        </tr>
                        <tr>
                            <th>색상</th>
                            <td colspan="3"><input type="text" name="color" class="form_input input_100" disabled
                                    value="<?=$row->COLOR?>"></td>
                        </tr>
                        <tr>
                            <th>수주수량</th>
                            <td colspan="3"><input type="text" name="QTY" class="form_input input_100 right" disabled
                                    value="<?php echo $row->QTY;?>"></td>
                        </tr>
                        <tr>
                            <th>1급</th>
                            <td colspan="3"><input type="text" name="A2" class="form_input input_100 right" readonly
                                    value="<?php echo $row->IN_QTY;?>"></td>
                        </tr>
                        <tr>
                            <th>2급</th>
                        ...
                        <tr>
                            <th>파손</th>
                            <td colspan="3"><input type="text" name="A4" size="6" class="form_input input_100 right"
                                    value=""></td>
                        </tr>
                        <tr>
                            <th>시유</th>
                            <td colspan="3"><input type="text" name="A5" size="6" class="form_input input_100 right"
                                    value=""></td>
                        </tr>
                        <tr>
                            <th>비고</th>
