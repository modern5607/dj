        ...
        <li>
            ...
            <div id="" class="bc_search gsflexst">
                <form>
                    ...
                    <input type="text" autocomplete="off" name="custnm" class="custnm"
                        value="<?php echo (!empty($str['custnm']) && $str['custnm'] != "")?$str['custnm']:"";?>"
                        size="12" />
            ...
            <div class="tbl-content">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					?>
                        ...
                        <tr>
                            <td colspan="15" class="list_none">검색 결과가 없습니다</td>
                        </tr>
                        <?php
				}?>
                    </tbody>
        ...
        <li>
            <div class="bc_header none_padding">
                ...
                <div class="ac_table">
                    ...
                    <span class="btni btn_right add_detail" data-hidx="<?php echo $HIDX; // idx?>"><span
                            class="material-icons">add</span></span>
                </div>
            ...
            <div class="tbl-content">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top: 2px;">
					...
					?>
                        <tr>
                            <td colspan="6" style='color:#999; padding:40px 0;'>수주항목이 없습니다.</td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
