                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					?>
                        ...
                        <tr <?php echo ($NDATE == $row->TRANS_DATE)?"class='over'":"";?>>
                            ...
                            <td class="cen"><a href='<?php echo base_url('ORD/o2/').$row->TRANS_DATE."?sdate=".$str['sdate']."&"."edate=".$str['edate']
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					?>
                        ...
                        <tr>
                            ...
                            <td><span class="<?php echo ($row->END_YN == "Y" || $todate < $now)?"nbtn":"btn del_items" ?>" 
                                data-idx="<?=$row->TRANS_IDX;?>"
                                data-inqty="<?php echo $row->ORDER_QTY; ?>" >삭제</span></td>
                        </tr>
...
$(".add_itemnum").on("click", function() {
    ...
    $.ajax({
        url: "<?php echo base_url('ORD/ajax_itemNum_form')?>",
        type: "POST",
        dataType: "HTML",
        data: {
            mode: "add",
