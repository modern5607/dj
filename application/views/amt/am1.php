	...
	<ul>
		<li style="width:25%;">
			...
			<form>
				...
				<input type="text" name="sdate" autocomplete="off" class="sdate calendar" value="<?php echo (!empty($str['sdate']) && $str['sdate'] != "")?$str['sdate']:date("Y-m-d",mktime(0,0,0,date("m"),1,date("Y")));?>" size="10" /> ~ 
				
				<input type="text" name="edate" autocomplete="off" class="edate calendar" value="<?php echo (!empty($str['edate']) && $str['edate'] != "")?$str['edate']:date("Y-m-d");?>" size="10" />
