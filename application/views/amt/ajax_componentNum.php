				...
				<table class="nhover">
					<tbody>
						...
						<tr>
							...
							<td><input type="number" name="IN_QTY" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form_input input_100" value="<?php echo (!empty($INFO)) ? $INFO->IN_QTY : ""; ?>" style="padding:6px 10px;"></td>
						</tr>
						<tr>
