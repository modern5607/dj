				...
				<tbody>
					...
					?>
							<tr>
								...
								<td class="right"><?php echo number_format($row->QTY); ?><input type="hidden" name="QTY[]" class="form_input1" value="<?php echo number_format($row->QTY); ?>"></td>

								<td style='padding:0px' class="cen"><input style="text-align:right; width:100px" type="number" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="C_QTY[]" class="form_input1 cen" size="6" value=""></td>
