                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr <?php echo ($NDATE == $row->TRANS_DATE) ? "class='over'" : ""; ?>>
                                    ...
                                    <td class="cen"><a href='<?php echo base_url('ACT2/a8/') . $row->TRANS_DATE . "?sdate=" . $str['sdate'] . "&" . "edate=" . $str['edate']
                        ...
                        <?php if (!empty($RList)) { ?>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="btn del_items" data-idx="<?= $row->TRANS_IDX; ?>" data-inqty="<?php echo $row->IN_QTY; ?>" data-shqty="<?php echo $row->SH_QTY; ?>">삭제</span></td>
                                    </tr>
