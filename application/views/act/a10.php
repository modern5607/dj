        ...
        <li style="width:420px">
            ...
            <div id="" class="bc_search">
                <form>
                    ...
                    <br>
                    <label>품목</label>
                    <input style="width:234px;margin-top: 5px;margin-left: 12px;" type="text" autocomplete="off" name="v3" size="6" value="<?php echo (!empty($str['v3'])) ? $str['v3'] : ""; ?>">
            ...
            <form name="ajaxform" id="ajaxform">
                ...
                <div class="bc_header none_padding">
                    ...
                    <?php if (!empty($detail)) { ?>
                        ...
                        <span class="btni btn_right form_submit" data-hidx="<?php //echo $HIDX; // idx
                                                                            ?>">저장</span>
