            ...
            success: function(data) {
                ...
                if (dataset.length > 0) {
                    $.each(dataset, function(index, info) {
                        ...
                        html += "<input style='text-align:right;' onKeyup=\"this.value=this.value.replace(/[^0-9]/g,'');\" type='text' autocomplete='off' name='QTY[]' class='form_select qty_this' size='4' value='' />";
