            ...
            success: function(data) {
                ...
                if (dataset.length > 0) {
                    $.each(dataset, function(index, info) {
                        ...
                        html +=
                            "	<input style='text-align:right;' onKeyup=\"this.value=this.value.replace(/[^0-9]/g,'');\" type='number' autocomplete='off' name='QTY[]' class='form_select qty_this' size='4' value='' />";
                        ...
                        html += "<td style='text-align:center;'><input style='text-align:right;' onKeyup=\"this.value=this.value.replace(/[^0-9]/g,'');\" type='text' name='BQTY[]' autocomplete='off' class='form_select qty_this' size='4' value='0'/></td>";
                    ...
                    html +=
                        "<tr><td colspan='8' style='text-align:center; color:#999;'>성형재고가 없습니다.</td></tr>"
                }
            ...
            success: function(data) {
                ...
                if (jsonData.status == "ok") {
                    ...
                    setTimeout(function() {
                        ...
                        $("#loading").hide();
                        location.replace("<?= base_url('ACT2/a9/')?>"+cur_date);
