            ...
            success: function(data) {
                ...
                if (dataset.length > 0) {
                    $.each(dataset, function(index, info) {
                        ...
                        html += "<td>";
                        html +=
                            "	<input type='text' style='text-align:right; width:100px' onKeyup=\"this.value=this.value.replace(/[^0-9]/g,'');\" autocomplete='off' name='QTY[]' class='form_select' size='4' value='' />";
            ...
            success: function(data) {
                ...
                if (jsonData.status == "ok") {
                    ...
                    setTimeout(function() {
                        ...
                        $("#loading").hide();
                        location.replace("<?= base_url('ACT2/a8/')?>"+cur_date);
