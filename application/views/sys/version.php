...
<div class="bc_header">
	<span class="btn btn_right add_verform">신규등록</span>
</div>

<div class="bc_cont">
	<div class="cont_header">버전리스트</div>
	<div class="cont_body">
	...
	<div id="info_content" class="info_content" style="height:auto;">
		...
		<div class="ajaxContent">
			...
			<div class="formContainer">
				...
				<form name="codeHead" id="codeHead" method="post" action="<?php echo base_url('SYS/upload_ver_form')?>" enctype="multipart/form-data" onsubmit="return xlsxupload(this)">
...
$(".deleteBtn").on("click",function(){
	...
	$.post("<?php echo base_url('SYS/delete_ver_form')?>",{IDX:idx},function(data){
		if(data > 0){
			alert('삭제를 완료했습니다');
			location.reload();
		}
...
$(".modi_Btn").on("click",function(){
	var idx = $(this).data("idx");
	$.post("<?php echo base_url('SYS/modified_ver_form')?>",{IDX:idx},function(data){
